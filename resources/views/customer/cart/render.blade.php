                            ...
                            <td>
                                <div class="me-3" style="width: 120px;">
                                    <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                        <input type="text" value="{{$cart->quantity}}" name="quantity" class="form-control quantity" data-id="{{$cart->id}}">
                                        <span class="input-group-btn-vertical">
                                            <button class="btn btn-primary bootstrap-touchspin-up quantity-update" type="button" data-cat='up' data-id="{{$cart->id}}" data-qty="{{$cart->quantity}}">+</button>
                                            <button class="btn btn-primary bootstrap-touchspin-down quantity-update" type="button" data-cat='down' data-id="{{$cart->id}}" data-qty="{{$cart->quantity}}">-</button>
                                        </span>
                                    </div>
                                </div>
                            </td>
