                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name"
                                placeholder="enter package name" autocomplete="off" autofocus>
                        </div>
                        <div class="form-group">
                            <label for="">Package Price</label>
                            <input type="text" class="form-control" name="price" id="price"
                                placeholder="enter package price" autocomplete="off" autofocus>
                        </div>
                        {{-- <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="image" id="image"
                                placeholder="enter package image" autocomplete="off" autofocus>
                        </div>
                        <div class="form-group">
                            <label for="">Package Address</label>
                            <textarea class="form-control" rows="5" name="address" id="name" placeholder="enter package address"
                                autocomplete="off" autofocus></textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Package Detail</label>
                            <textarea class="form-control" name="detail" rows="5" id="name" placeholder="enter package detail"
                                autocomplete="off" autofocus></textarea>
                        </div>
                    </div>
