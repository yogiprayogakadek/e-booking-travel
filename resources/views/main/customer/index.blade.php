                        ...
                        <tbody>
                            @foreach ($customers as $customer)
                                <tr>
                                    ...
                                    <td><img src="{{ asset($customer->photo) }}" width="100px"></td>
                                    <td>
                                        <span
                                            class="badge {{ $customer->is_active == true ? 'badge-primary' : 'badge-danger' }}">{{ $customer->is_active == true ? 'Active' : 'Inactive' }}</span>
                                    </td>
                                    {{-- @can('operator')
                                        <td>
                                            <a href="{{ route('category.edit', $customer->id) }}">
